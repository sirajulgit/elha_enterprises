                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Resource Add</h3>

                            <div class="card-tools">
                                <a href="{{ route('resource_list') }}" class="btn btn-primary">Back</a>
                            </div>
                        </div>
                        <!-- /.card-header -->

                        <form id="quickForm" action="{{ route('post_resource_create') }}" method="POST"

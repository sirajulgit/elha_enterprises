            ...
            <div class="row">
                ...
                <div class="col-lg-12 mb-5">
                    <div class="card">
                        ...
                        <div class="card-header" style="background-color: #3498db;">
                            <h3 class="card-title badge badge-success font-weight-bold">FAQ</h3>
                        </div>
                        <!-- /.card-header -->

                        <form id="faq_form" action="{{ route('post_cms_home') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf

                            <input type="hidden" name="id" value="{{ $items['faq']['id'] }}" />

                            <div class="card-body row">

                                <div class="form-group col-md-12">
                                    <label for="head_title">Head Title</label>
                                    <textarea id="faq_head_title2" name="head_title" class="form-control" rows="5">{{ $items['faq']['head_title'] }}</textarea>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div id="inputContainerfaq">
                                        @if (count($items['faq']['badge_data']) > 0)
                                            @foreach ($items['faq']['badge_data'] as $item)
                                                <div class="row multi_choice_sections">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <textarea name="old_badge_details_1[]" class="form-control badge_details_1_{{ $item['id'] }}" rows="5"
                                                            placeholder="FAQ Description">{{ $item['badge_details_1'] }}</textarea>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <button type="button" class="btn btn-info mb-3 updateInputfaq"
                                                            data-badge-id="{{ $item['id'] }}">Update</button>

                                                        <button type="button" class="btn btn-danger mb-3 removeInputfaq"
                                                            data-badge-id="{{ $item['id'] }}">Remove</button>
                                                    </div>
                                                </div>
                                            @endforeach
                                        @else
                                            <div class="row multi_choice_sections">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <input type="text" class="form-control text-input"
                                                        name="badge_title_1[]" placeholder="FAQ Question">
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <button type="button"
                                                        class="btn btn-danger mb-3 removeInputfaq">Remove</button>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
...
@section('script_content')
    <script>
        $(document).ready(function() {
            ...
            // Remove input field
            $('#inputContainerfaq').on('click', '.removeInputfaq', function() {
            ...
            // Update input field
            $('#inputContainerfaq').on('click', '.updateInputfaq', function() {
            ...
            ///////////////// End dynamic add more fields (faq) ////////////////////////////

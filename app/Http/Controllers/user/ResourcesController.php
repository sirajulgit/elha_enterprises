...
class ResourcesController extends Controller
{
    ...
    public function import_export_guideline(){
        ...
        return view('user.import_export_guidelines', ['data' => $data, 'homedata' => $items]);
    }
    public function sourcing_importing_products(){
        $data = [
            'page_title' => 'Guidance for Importers and Exporters',
            'activePageName' => 'resources',
        ...
        return view('user.sourcing_importing_products', ['data' => $data, 'homedata' => $items]);
    }
    
    public function international_payment_methods(){
        $data = [
            'page_title' => 'Guidance for Importers and Exporters',
            'activePageName' => 'resources',
        ...
        return view('user.international_payment_methods', ['data' => $data, 'homedata' => $items]);
    }
    public function customs_clearance(){
        ...
        return view('user.customs_clearance', ['data' => $data, 'homedata' => $items]);
    }
    
    public function duty_payments(){
        $data = [
            'page_title' => 'Guidance for Importers and Exporters',
            'activePageName' => 'resources',
        ...
        return view('user.duty_payments', ['data' => $data, 'homedata' => $items]);
    }
    public function incoterms(){
        ...
        return view('user.incoterms', ['data' => $data, 'homedata' => $items]);
    }
    
    public function us_customs_declarations(){
        $data = [
            'page_title' => 'Guidance for Importers and Exporters',
            'activePageName' => 'resources',
        ...
        return view('user.us_customs_declarations', ['data' => $data, 'homedata' => $items]);
    }

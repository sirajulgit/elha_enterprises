...
class ServiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("admin.service.service_list", ["data" => $data]);
    }
    ...
    public function create()
    {
        ...
        return view("admin.service.service_create", ["data" => $data]);
    }
    ...
    public function update(Request $request)
    {
        ...
        return view("admin.service.service_edit", ["data" => $data]);
    }
    ...
    public function post_update(Request $request)
    {
        ...
        $old_image_name = Service::find($request->id)->image;
